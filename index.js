...
const SESSION_ID = 'levanter_saeedxdiebot2' // Edit this line only, don't remove ' <- this symbol

let nodeRestartCount = 0
const maxNodeRestarts = 5
const restartWindow = 10000 // 10 seconds
...
function cloneRepository() {
  ...
  const cloneResult = spawnSync(
    'git',
    ['clone', 'https://github.com/saeedx302/levanter.git', 'levanter'],
    {
      stdio: 'inherit',
    }
  )
